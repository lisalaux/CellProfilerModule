...
There are two steps to writing a successful interaction.
The first is to call workspace.interaction_request inside the module's run method.
The second is to write your interaction_handler to handle the interaction reequest.

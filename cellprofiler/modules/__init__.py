...
pymodule_to_cpmodule = {'align': 'Align',
                        'automatedevaluation_module': 'AuotmatedEvaluation',
                        ...
                        'erosion': 'Erosion',
                        'manualevaluation_module': 'ManulaEvaluation',
                        'example2c_interactive': 'ExampleInteractive',
...
builtin_modules = ['align',
                   ...
                   'erosion',
                   'manualevaluation_module',
                   'example2c_interactive',
